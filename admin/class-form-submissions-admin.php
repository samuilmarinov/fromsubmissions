...
function Form_Submissions_add_settings_page() {
    add_options_page( 'Form Submissions', 'System Settings', 'manage_options', 'Form_Submissions', 'Form_Submissions_render_plugin_settings_page' );
}
...
{
   add_menu_page(__('submissions', 'cltd_example'), __('submissions', 'cltd_example'), 'activate_plugins', 'submissions', 'cltd_example_submissions_page_handler');
   add_submenu_page('submissions', __('submissions', 'cltd_example'), __('submissions', 'cltd_example'), 'activate_plugins', 'submissions', 'cltd_example_submissions_page_handler');
...
<div class="wrap">
   ...
   <h2><?php _e('submissions', 'cltd_example')?> <a class="add-new-h2"
...
{   
   ...
   add_meta_box('submissions_form_meta_box', 'Submission data', 'cltd_example_submissions_form_meta_box_handler', 'submission', 'normal', 'default');

   ?>
<div class="wrap">
   <div class="icon32 icon32-posts-post" id="icon-edit"><br></div>
   <h2><?php _e('submission', 'cltd_example')?> <a class="add-new-h2"
